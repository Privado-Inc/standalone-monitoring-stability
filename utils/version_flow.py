...
def check_update(github_token):
    ...
    clone_repo_with_name(config.get_privado_core_url(github_token), builder.get_joern_privado_path("first"), "privado-core-internal")

    # clone second privado-core, used for updating the dependencies
    clone_repo_with_name(config.get_privado_core_url(github_token), builder.get_joern_privado_path("second"), "privado-core-internal")
