...
parser.add_argument('-bcr', '--base-core-repo', default='NA')
parser.add_argument('-hcr', '--head-core-repo', default='NA')
parser.add_argument('-brr', '--base-rule-repo', default='NA')
parser.add_argument('-hrr', '--head-rule-repo', default='NA')
